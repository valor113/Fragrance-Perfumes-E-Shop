    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-column footer-about">
                <h4 class="footer-column-title">The Art of Fragrance</h4>
                <p>Welcome to our online boutique, where the mastery of perfumery meets modern elegance.</p>
                <p>Our mission is to bring you exclusive scents that highlight your personality and leave an unforgettable impression.</p>
            </div>
        </div>
        <div class="footer-bottom">
            <p class="footer-copyright">&copy; 2026 Maison Doree.</p>
